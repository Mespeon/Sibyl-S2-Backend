def preparePayload():
	base_url = 'https://raw.githubusercontent.com/Mespeon/Sibyl-S2-Backend/master/psychopass/resources/'
	descriptors = [
	...
	cardPhotos = [
	base_url + 'cover/honoka-cover.jpg',
	base_url + 'cover/kotori-cover.jpg',
	base_url + 'cover/umi-cover.jpg',
	base_url + 'cover/hanayo-cover.jpg',
	base_url + 'cover/maki-cover.jpg',
	base_url + 'cover/rin-cover.jpg',
	base_url + 'cover/nico-cover.jpg',
	base_url + 'cover/eli-cover.jpg',
	base_url + 'cover/nozomi-cover.jpg',
	base_url + '',
	base_url + '',
	base_url + '',
	base_url + '',
